  ...
  return (
    <div className="relative flex flex-col min-h-screen bg-indigo-100/50 pb-3 px-4 pt-2 backdrop-blur sm:px-6 sm:pb-20 lg:px-12 xl:pb-6 3xl:px-56 3xl:pt-2.5">
      ...
      <div className="flex flex-1 flex-col w-full min-h-screen">
        ...
        {/* product */}
        <div className="w-full h-full flex flex-1 pb-12">
          <div className="grid w-full auto-rows-max auto-cols-max flex-1 grid-rows-6 grid-cols-4 large:grid-rows-6 large:grid-cols-10 large:grid-flow-col grid-flow-row gap-4">
